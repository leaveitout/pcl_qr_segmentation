...
//                double child_area_poly = approxPolyArea(contours[deep_contours[i]], 1.0);
//                double parent_area_poly = approxPolyArea(contours[parent_index], 1.0);
//                double grandparent_area_poly = approxPolyArea(contours[grand_parent_index], 1.0);
//                double parent_area_ratio_poly = parent_area_poly / child_area_poly;
//                double grandparent_area_ratio_poly = grandparent_area_poly / child_area_poly;
//                cout << "Ratios: \t" << parent_area_ratio << "\t" << grandparent_area_ratio << endl;
//                cout << "Poly rations: \t" << parent_area_ratio_poly << "\t" << grandparent_area_ratio_poly << endl;
...
//        cout << "Result Landmark locations: " << endl;
//        for(auto r: results)
//            cout << r.x << "\t" << r.y << endl;
        return results;
    }
